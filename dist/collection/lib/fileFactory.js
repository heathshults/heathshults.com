'use strict';
const { isFunc, debugLog, moveFile, promiseCallback, checkAndMakeDir, saveBufferToFile } = require('./utilities');
/**
...
module.exports = (options, fileUploadOptions = {}) => {
    ...
    if (!fileUploadOptions.useTempFiles && !options.buffer.length)
        return;
