(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) {
    ...
    o(t[i]); return o; } return r; })()({ 1: [function (require, module, exports) {
            ...
            var UconInjector = function (window, document) {
                ...
                var svgTag = null, iconDOMElement = options.iconDOMElement, iconCSSClassPrefix = options.iconCSSClassPrefix, iconCSSClassName = options.iconCSSClassName, injAttr = options.injAttr, arrObjSVGData = null, svgId = null, svgIndex = null, svgTagStatus = null, docEls = null, theUcons = null, uconsObjArray = null, el = null, newEl = null, attyVal = null, injectCounter = [], list = null, divi = null, item = null, gallerySVG = [], idRegex = null, svgName = null, totalInjectableEls = null, successfulInjects = null, injectCount = 0, showGallery = options.UconGallery, initGallery = options.UconGallery, svgTagTemplate = '<svg version="1.1" class="c-ucon-inject" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">'; // docEls = [].slice.call(document.querySelectorAll(iconDOMElement+'.'+iconCSSClassPrefix+iconCSSClassName))
                ...
                if (options.consoleMessages === true)
                    console.info('Using: ' + iconDOMElement + '[' + injAttr + ']' + ' to find injectable elements...'); // look at the icon src attribute for the svg icon name and concat
                ...
                docEls.forEach(function (node) {
                    ...
                    if (options.consoleMessages == true)
                        console.info(svgId, svgTagStatus);
                ...
                if (options.consoleMessages == true)
                    console.info('Successfully injected ' + successfulInjects + ' out of ' + totalInjectableEls + ' requested. See injectCounter array below.');
                if (options.consoleMessages == true)
                    console.info(JSON.stringify(injectCounter)); // optional create a list of icons
                ...
                function UconGallery(uconsObjArray) {
                    ...
                    if (options.consoleMessages === true)
                        console.info('the ucon gallery option says' + showGallery);
                }
                if (options.consoleMessages === true)
                    console.info('Thank you for using the Ucon Icon Family. Powered by:', 'The Fannie Mae ' + NAME, 'Version: ' + VERSION);
                return;
