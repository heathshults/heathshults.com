    ...
    GridStack.prototype._prepare_element = function (el) {
        ...
        el.draggable({
            ...
            drag: function (event, ui) {
                var x = Math.round(ui.position.left / cell_width), y = Math.floor(ui.position.top / cell_height);
        ...
        if (!el.attr('data-gs-no-resize')) {
            el.resizable({
                ...
                resize: function (event, ui) {
                    var width = Math.round(ui.size.width / cell_width), height = Math.round(ui.size.height / cell_height);
